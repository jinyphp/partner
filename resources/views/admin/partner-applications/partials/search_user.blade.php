...
<input type="hidden" name="user_table" id="user_table" value="{{ old('user_table', isset($item) ? ($item->user_table ?? 'users') : '') }}">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text"
                       ...
                       value="{{ old('search_email', isset($item) ? ($item->personal_info['email'] ?? $item->user->email ?? '') : '') }}"
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="email"
                       ...
                       id="email"
                       value="{{ old('personal_info.email', isset($item) ? ($item->personal_info['email'] ?? $item->user->email ?? '') : '') }}"
                       readonly>
            ...
            <div class="col-md-6">
                ...
                <input type="text"
                       ...
                       id="name"
                       value="{{ old('personal_info.name', isset($item) ? ($item->personal_info['name'] ?? $item->user->name ?? '') : '') }}"
                       readonly>
