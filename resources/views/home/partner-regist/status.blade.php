            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        @if($currentApplication && $currentApplication->referral_code)
                            <div class="text-end">
                                <div class="small text-muted mb-1">사용한 추천 코드</div>
                                <div class="badge bg-primary font-monospace">
                                    {{ $currentApplication->referral_code }}
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                @if ($hasReferrer && isset($referrerInfo))
                    <div class="card mb-4 border-0 shadow-lg"
                        ...
                        <div class="card-body p-4 text-white">
                            ...
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center py-2 border-bottom border-white border-opacity-20">
                                    <div class="fw-bold text-white small">추천인</div>
                                    <div class="text-white small">{{ $referrerInfo['name'] ?? '알 수 없음' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center py-2 border-bottom border-white border-opacity-20">
                                    <div class="fw-bold text-white small">등급</div>
                            ...
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center py-2 border-bottom border-white border-opacity-20">
                                    <div class="fw-bold text-white small">사용된 코드</div>
                                    <div class="text-white font-monospace small">
                                        {{ $referrerInfo['referral_code_used'] ?? 'N/A' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center py-2 border-bottom border-white border-opacity-20">
                                    <div class="fw-bold text-white small">추천인 파트너 코드</div>
                                    <div class="text-white font-monospace small">
                                        {{ $referrerInfo['partner_code'] ?? 'N/A' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center py-2 border-bottom border-white border-opacity-20">
                                    <div class="fw-bold text-white small">이메일</div>
                                    <div class="text-white small">{{ Str::limit($referrerInfo['email'] ?? '', 20) }}</div>
                                </div>
                            </div>

                            <div class="mb-4">
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="fw-bold text-white small">추천 방법</div>
                                    <div class="text-white small">
                                        {{ ucfirst(str_replace('_', ' ', $referrerInfo['referral_source'] ?? 'online link')) }}
                                    </div>
                                </div>
                            </div>
