...
namespace Jiny\Partner\Http\Controllers\Home\Status;
...
class IndexController extends PartnerController
{
    ...
    /**
     * 파트너 신청 상태 페이지
     * - JWT 로그인한 회원의 신청 상태 확인
     * - ID 없이 사용자 UUID로 신청서 조회
     * - 상태별 안내 메시지 및 액션 표시
     */
    public function __invoke(Request $request)
    {
        ...
        // Step3. JWT 사용자의 신청서 조회 (가장 최근 신청서)
        ...
        return view('jiny-partner::home.status.index', [
            'user' => $user,
            ...
            case 'reviewing':
                return [
                    ...
                    'actions' => [
                        [
                            'label' => '진행 상황 확인',
                            'url' => "/home/partner/regist/status",
                            'class' => 'btn-outline-primary'
                        ]
                    ],
                    'color' => 'warning'
